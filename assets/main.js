...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function ($) {
	  ...
	  $("#mobile-menu .has-children > a").click(function (event) {
	  ...
	  $(document).on('click touchstart', function (event) {
	    ...
	    if (!$target.parents().addBack().is("#menu-my-list,#menu-login")) {
	      $('#menu-login').removeClass('active');
	    };
	    if (!$target.parents().addBack().is("#logged-icon")) {
	      $("#logged-icon").removeClass('active');
	    };
	    if (!$target.parents().addBack().is("#search-form")) {
	  ...
	  function slider(context) {
	    ...
	    var speed = 600,
	        pause = 3000;
	    $('#home-hero ul', context).each(function () {
	    ...
	    $('#home-our-brands .slider ul').bxSlider({
	      minSlides: 1,
	      maxSlides: 3,
	      slideWidth: 300,
	      slideMargin: 32,
	    ...
	    $('#home-whats-new .slider ul').bxSlider({
	    ...
	    $('#related-products .slider ul').bxSlider({
	      minSlides: _minSlides,
	      maxSlides: 4,
	      slideWidth: 300,
	      slideMargin: 32,
